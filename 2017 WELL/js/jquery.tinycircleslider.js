    ...
    function Plugin($container, options) {
        ...
        function _setDots() {
            ...
            $slides.each(function(index, slide) {
                ...
                ,   position = {
                    ...
                    ,   left: Math.sin(_toRadians(angle)) * self.options.radius + containerSize.width / 2 - dotSize.width / 2 - 80
                    }
                ;
       ...
       /**
        ...
        function _setCSS(angle, fireCallback) {
            ...
            ,   left: Math.sin(_toRadians(angle)) * self.options.radius + (containerSize.width / 2 - thumbSize.width / 2) - 65
            });
