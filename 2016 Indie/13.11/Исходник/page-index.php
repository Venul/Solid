...
<div class="container cup">
    <div class="col-md-5">
        <img src="<?= get_template_directory_uri(); ?>/img/img-main-banner.png" alt=""/>
    </div>
    <div class="col-md-7">
        <div class="prize-txt">
...
<div class="arrow-down">
    <img src="<?= get_template_directory_uri(); ?>/img/ic-scroll-down.png" alt=""/>
</div>
...
<div class="partners">
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item">
                <img class="first-slide" src="<?= get_template_directory_uri(); ?>/img/img-banner-optional.png"
                     alt="First slide"/>
            </div>
            <div class="item">
                <img class="second-slide" src="<?= get_template_directory_uri(); ?>/img/img-banner-optional.png"
                     alt="Second slide"/>
            </div>
            <div class="item active">
                <img class="third-slide" src="<?= get_template_directory_uri(); ?>/img/img-banner-optional.png"
                     alt="Third slide"/>
            </div>
        </div>
        <div class="container">
            <a class="left carousel-control" href="http://getbootstrap.com/examples/carousel/#myCarousel" role="button"
               data-slide="prev">
                <img src="<?= get_template_directory_uri(); ?>/img/ic-left.png" alt=""/>
            </a>
            <a class="right carousel-control" href="http://getbootstrap.com/examples/carousel/#myCarousel" role="button"
               data-slide="next">
                <img src="<?= get_template_directory_uri(); ?>/img/ic-right.png" alt=""/>
            </a>
        </div>
    </div>
    <div class="container">
...
<div class="nomination container">
    ...
    <div class="nominations-list">
        <div class="col-md-3">
            <img src="<?= get_template_directory_uri(); ?>/img/ic-art.png" alt=""/>
            <p>Лучший арт</p>
        </div>
        <div class="col-md-3">
            <img src="<?= get_template_directory_uri(); ?>/img/ic-vr.png" alt=""/>
            <p>Лучшая VR игра</p>
        </div>
        <div class="col-md-3">
            <img src="<?= get_template_directory_uri(); ?>/img/ic-pc.png" alt=""/>
            <p>Лучшая PC игра</p>
        </div>
        <div class="col-md-3">
            <img src="<?= get_template_directory_uri(); ?>/img/ic-mobile.png" alt=""/>
    ...
    <section class="regular col-lg-12">
        <div>
            <a href="/participants/madness-road">
                <img src="<?= get_template_directory_uri(); ?>/img/img-new-player-optional-1.png" alt=""/>
                <p>Madnes road</p>
            </a>
        </div>
        <div>
            <a href="/participants/madness-road">
                <img src="<?= get_template_directory_uri(); ?>/img/img-new-player-optional-2.png" alt=""/>
                <p>Illumination</p>
            </a>
        </div>
        <div>
            <a href="/participants/madness-road">
                <img src="<?= get_template_directory_uri(); ?>/img/img-new-player-optional-3.png" alt=""/>
                <p>Madnes road</p>
            </a>
        </div>
        <div>
...
<div class="our-partners container">
    ...
    <div class="platinum">
        ...
        <div class="group-partners">
            <div class="col-md-6">
                <img src="<?= get_template_directory_uri(); ?>/img/logo-golden-partners-optional.png"/>
                <p>Indie Prize</p>
            </div>
            <div class="col-md-6">
                <img src="<?= get_template_directory_uri(); ?>/img/logo-golden-partners-optional_2.png"/>
                <p>Razer</p>
            </div>
        </div>
    </div>
    ...
    <div class="partner-nomin">
        ...
        <div class="group-partners">
            <div class="col-md-2">
                <img src="<?= get_template_directory_uri(); ?>/img/partner-logo-optional_3.png"/>
                <p>Ea Games</p>
            </div>
            <div class="col-md-2">
                <img src="<?= get_template_directory_uri(); ?>/img/partner-logo-optional_4.png"/>
                <p>Blizzard Games</p>
            </div>
            <div class="col-md-2">
                <img src="<?= get_template_directory_uri(); ?>/img/partner-logo-optional_5.png"/>
                <p>GLU Games</p>
            </div>
            <div class="col-md-2">
                <img src="<?= get_template_directory_uri(); ?>/img/partner-logo-optional.png"/>
                <p>Good Games</p>
            </div>
            <div class="col-md-2">
                <img src="<?= get_template_directory_uri(); ?>/img/partner-logo-optional_2.png"/>
                <p>DigiCode</p>
            </div>
        </div>
        <p>Инфопартнеры</p>
