...
<!-- Page start -->
        <div class="about-us-page container">
            ...
            <div class="col-md-6 m-lg-top">
                <img class="img-responsive src="<?= get_template_directory_uri(); ?>/img/about-1.png" alt="" />
            </div>
            <div class="col-md-6 m-lg-top">
                <img class="img-responsive src="<?= get_template_directory_uri(); ?>/img/about-2.png" alt="" class="p-md-left"/>
            </div>
            <div class="col-md-12">
                <img class="img-responsive src="<?= get_template_directory_uri(); ?>/img/about-3.png" alt="" />
            </div>
        </div>
