...
?>
        <div class="participant-page container">
            <div class="top-info-participant container">
                <div class="col-md-7">
            ...
            <div class="center-txt-participant container">
               <?= the_content(); ?>
            </div>
            ...
            <div class="new-members container">
                <section class="regular slider col-lg-12">
                    <div><a>
                      <img class="img-responsive" src="http://138.68.83.3/wp-content/themes/indiecup/img/img-new-player-optional-1.png" alt="">
                      <p>Madnes road</p></a>
                    </div>
                    <div><a>
                      <img class="img-responsive" src="http://138.68.83.3/wp-content/themes/indiecup/img/img-new-player-optional-2.png" alt="">
                      <p>Illumination</p></a>
                    </div>
                    <div><a>
                      <img class="img-responsive" src="http://138.68.83.3/wp-content/themes/indiecup/img/img-new-player-optional-3.png" alt="">
                      <p>Madnes road</p></a>
                    </div>
                    <div><a>
                      <img class="img-responsive" src="http://138.68.83.3/wp-content/themes/indiecup/img/img-new-player-optional-1.png" alt="">
